...
async def help(bot, message, cb=False):
    ...
    button = [[
        ...
        InlineKeyboardButton(f'📦 SOURCE', url='https://github.com/TheOnlyMrLucifer/MegaByLucifer'),
...
async def start(bot, message, cb=False):
    ...
    owner_username = owner.username if owner.username else 'TheOnlyMrLucifer'
    button = [[
    ...
    if Config.UPDATES_CHANNEL:
        ...
        try:
            ...
            if user.status == "kicked":
                await message.message.edit(
                    text="Sorry Mate, You are Banned. Contact My [18+ Group](https://t.me/PeriOFiGPeeksTango).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await message.message.edit(
                text="**You Still Didn't Join ☹️, Please Join My Group To Use Me!**\n\nDue to Overload, Only Group Subscribers Can Use Me!",
            ...
            await message.message.edit(
                text="Something Went Wrong. Contact My [18+ Group](https://t.me/PeriOFiGPeeksTango).",
                parse_mode="markdown",
                disable_web_page_preview=True
            )
            return
